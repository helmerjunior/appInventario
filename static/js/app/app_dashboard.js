/*COMPROBAR SI ESTO PUEDE IR EN UN SCRIPT DIRECTO EN LA PAGINA*/

$(function	()	{

	//Flot Chart
	//Website traffic chart				
	var init = { data: [ [1, 8], [2, 5], [3, 8], [4, 7], [5,9], [6, 8], [7, 8], [8, 10], [9, 24], [10, 10]],
			 label: "Ventas"
		},
		options = {	
			series: {
	...
	var donutChart = Morris.Donut({
	  element: 'donutChart',
	  data: [
		{label: "En inventario", value: 500},
		{label: "Reservados", value: 400}
	  ],
	...
	var lineChart = Morris.Line({
		element: 'lineChart',
		data: [
			{ d: '2014-08-20', a: 30,  b: 20 },
			{ d: '2014-08-21', a: 45,  b: 35 },
			{ d: '2014-08-22', a: 60,  b: 60 },
			{ d: '2014-08-23', a: 75,  b: 65 },
			{ d: '2014-08-24', a: 50,  b: 70 },
			{ d: '2014-08-25', a: 80,  b: 85 },
			{ d: '2014-08-26', a: 100, b: 90 }
		],
		xkey: 'd',
		grid: false,
		ykeys: ['a', 'b'],
